...
(пункт 5 меню) принимает файл вне `inputs/` (копируется внутрь) **или**
http/https-ссылку — скачивает yt-dlp в `inputs/` (1080p max, `--no-playlist`).
Для url-режима: `pip install 'autoreels[url]'`.
